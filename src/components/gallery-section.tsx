...
export default function GallerySection() {
  return (
    <div className="flex flex-col gap-20 items-center justify-start px-8 py-32 w-full" data-name="Section Container" data-node-id="8067:23051">
      <div className="flex items-end justify-between w-full" data-name="Header" data-node-id="8071:32925">
        <div className="flex flex-col items-start justify-center max-w-3xl" data-name="Title Container" data-node-id="8071:32926">
          <div className="font-['Inter:Semi_Bold',_sans-serif] font-semibold leading-[0] not-italic text-[#22252b] text-[48px]" data-node-id="8071:32927">
            <p className="leading-[56px]">Explore our gallery of website templates</p>
          </div>
        </div>
      ...
      <div className="h-[400px] overflow-x-auto overflow-y-hidden w-full" data-name="Automatic Scroll" data-node-id="8266:74152">
        <div className="grid grid-cols-3 gap-6 h-full " style={{ width: 'max-content' }}>
          {templates.map((template) => (
            <div key={template.id} className="flex flex-col gap-3 h-[400px] items-start justify-end p-10 rounded-[16px] w-[450px] relative overflow-hidden" data-name="Card">
              <div 
              ...
              <div className="flex items-center justify-between relative z-10 w-full">
                {/* <div className="font-['Inter:Semi_Bold',_sans-serif] font-semibold text-[32px] text-white tracking-[-1px]">
                  <p className="leading-[40px]">{template.name}</p>
                </div> */}
                {/* <div className="flex items-center justify-center p-[10px] rounded-[8px] border border-[#d0d1d4] bg-white/10 backdrop-blur-sm">
